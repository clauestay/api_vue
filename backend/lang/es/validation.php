...
return [
    ...
    */
    ...
    'attributes' => [
        'entregados.*.run' => 'run',
        'entregados.*.v_run' => 'run',
        'entregados.*.problemas' => 'problemas',
        'entregados.*.examenes' => 'examenes',
        'fallecidos.*.run' => 'run',
        'fallecidos.*.v_run' => 'run',
        'fallecidos.*.fecha_fallecido' => 'fecha fallecido',
        'traslados.*.run' => 'run',
        'traslados.*.v_run' => 'run',
        'traslados.*.detalle.cod_unidad_origen' => 'cod. unidad origen',
        'traslados.*.detalle.pieza_origen' => 'pieza origen',
        'traslados.*.detalle.cama_origen' => 'cama origen',
        'traslados.*.detalle.cod_unidad_destino' => 'cod. unidad destino',
        'traslados.*.detalle.pieza_destino' => 'pieza destino',
        'traslados.*.detalle.cama_destino' => 'cama destino',
        'cirugias.*.run' => 'run',
        'cirugias.*.v_run' => 'run',
        'cirugias.*.intervencion' => 'cirugia',
        'cirugias.*.fecha_inicio' => 'fecha inicio',
        'cirugias.*.fecha_fin' => 'fecha fin',
    ],
