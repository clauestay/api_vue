...
<template>
  <div class="relative">
    <div class="min-h-screen bg-[#F2EFEF] pt-16">
      <nav
        class="bg-[#FBFBFB] border-b border-gray-100 fixed w-full top-0 z-10"
      >
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <a
                  class="inline-flex items-center px-1 pt-1 border-b-2 text-blue-400 hover:text-gray-500"
                ...
                <Dropdown align="right" width="48">
                  <template #trigger>
                    <span class="inline-flex rounded-md">
                      ...
                      >
                        <svg
                          class="w-6 h-6 text-[#8FA1E6] dark:text-white"
                          aria-hidden="true"
