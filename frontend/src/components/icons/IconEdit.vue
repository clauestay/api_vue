<template>
    <svg class="fill-[#FFFF00] text-white w-11 h-11 cursor-pointer"
         xmlns="http://www.w3.org/2000/svg"
         viewBox="0 0 512 512">

         <rect class=" hover:fill-red-800" width="57" height="53" rx="9"
         transform="translate(1552 647)" />

         <g class="fill-white" transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
